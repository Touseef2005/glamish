...
import getUnpublishedData from "../services/unpublishedProducts.js";
import ProductModel from "../models/index.js"
import { decodeVerifiedToken, fallbackHandler } from '../../../utils/index.js'

const getUnpublishedProductsController = async (req, res) => {
    ...
    try {
        ...
        const dataPaginate = await fallbackHandler({
            ...
            dbFetchFunction: async () => {
                const products = await getUnpublishedData({ limit: recordsLimit, skip: recordsSkip, search });
...
export default getUnpublishedProductsController;
